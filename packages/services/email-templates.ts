...
export function createTestEmailTemplate(data: TestEmailTemplateData): EmailTemplate {
  return {
...
export function createAINotificationEmailTemplate(data: AINotificationTemplateData): EmailTemplate {
  return {
...
export function createNotificationEmailTemplate(data: NotificationEmailTemplateData): EmailTemplate {
  return {
